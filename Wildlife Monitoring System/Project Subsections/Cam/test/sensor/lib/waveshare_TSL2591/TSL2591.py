...
class TSL2591:
    def __init__(self, address=ADDR):
        ...
        GPIO.setup(INI_PIN, GPIO.IN, pull_up_down=GPIO.PUD_UP)
        GPIO.add_event_detect(INI_PIN, GPIO.FALLING, callback=interrupt_handler)        
    ...
    def SET_InterruptThreshold(self, HIGH, LOW):
        ...
        self.Write_Byte(NPAILTL_REGISTER, LOW & 0xFF)
        self.Write_Byte(NPAILTH_REGISTER, LOW >> 8)
        
        self.Write_Byte(NPAIHTL_REGISTER, HIGH & 0xFF )
        self.Write_Byte(NPAIHTH_REGISTER, LOW >> 8 )
        #self.Disable()
    ...
    def TSL2591_SET_LuxInterrupt(self, SET_LOW, SET_HIGH):
        ...
        self.Write_Byte(NPAILTL_REGISTER, SET_LOW & 0xFF)
        self.Write_Byte(NPAILTH_REGISTER, SET_LOW >> 8 )
        
        self.Write_Byte(NPAIHTL_REGISTER, SET_HIGH & 0xFF )
        self.Write_Byte(NPAIHTH_REGISTER, SET_HIGH >> 8 )
        #self.Disable()
